package org.powerpoint.window.layout;
...
public class MarginLayout implements LayoutManager {
    ...
    public void layoutContainer(Container parent) {
        ...
        // 因为边距的存在，修改组件的 Size 和 Location
        Component component = parent.getComponent(0);
        component.setSize(this.calculateComponentSize(parent.getSize()));   // 计算组件的大小
        component.setLocation(this.calculateComponentLocation());           // 计算组件的位置
    }
